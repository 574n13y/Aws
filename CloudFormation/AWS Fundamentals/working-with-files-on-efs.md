...
3. Add a rule to the security group to allow the NFS protocol from group members
...
5. Launch an instance in US-EAST-1B
...
6. Unmount (make sure to change the directory out of efs-mount-point first)
